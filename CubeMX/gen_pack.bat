...
REM ************
REM   Copy mruby files to Files directory
REM ************
ECHO .git > XCopyExcludes.txt
FOR %%v IN (1.4.1 2.0.0) DO (
    ECHO Copying mruby %%v files. Be patient...
    XCOPY /EXCLUDE:XCopyExcludes.txt /I /Q /S /Y ..\mruby\mruby-%%v Files\Middlewares\Third_Party\mruby-%%v
)
DEL /q XCopyExcludes.txt
